...
//#######################################################################################################
#   define MAP(A, B) {A, B},
    std::unordered_map <std::string, std::string> extensionToMimeMappings = {
...
//#######################################################################################################
    ...
    {
        auto iter = extensionToMimeMappings.find(extension);
        if (iter == std::end(extensionToMimeMappings))
            return "";
        else
            return iter->second;
    }
